...
export const register = (name , password , phoneNumber ) => async (dispatch) => {
    try {
        dispatch({
        ...
        const { data } = await axios.post(
            '/api/users/register/',
            { 'name': name , 'password': password , 'phoneNumber': phoneNumber  },
            config
        )
...
export const resendCode = (code) => async (dispatch , getState) => {
    try {
        dispatch({
