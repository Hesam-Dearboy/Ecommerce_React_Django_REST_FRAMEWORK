...
export const productBrandListReducer = (state = {productsBrand : []} , action) => {
    switch(action.type){
        case PRODUCT_BRAND_LIST_REQUEST:
            return {loading:true , productsBrand:[]}

        case PRODUCT_BRAND_LIST_SUCCESS:
            return {loading:false ,
                 productsBrand: action.payload.productsBrand ,
                 page : action.payload.page ,
                 pages : action.payload.pages  }
...
export const productCategoryListReducer = (state = {productsCategory : []} , action) => {
    switch(action.type){
        ...
        case PRODUCT_CATEGORY_LIST_SUCCESS:
            return {loading:false ,
                 productsCategory: action.payload.productsCategory ,
                 page : action.payload.page ,
                 pages : action.payload.pages  }
...
export const bannersListReducer = (state = {banners:[]} , action) => {
    switch(action.type){
        case BANNER_REQUEST:
